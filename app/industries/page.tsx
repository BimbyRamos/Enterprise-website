      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p 
            ...
            style={{ color: '#475569' }}
          >
            Delivering tailored solutions and deep industry knowledge to help businesses thrive in their respective markets
          </p>
        </div>
      </section>
            ...
            {industries.map((industry, index) => (
              ...
              >
                ...
                <div className="relative flex flex-col h-full">
                  ...
                  >
                    <span className="text-3xl" role="img" aria-label={`${industry.name} icon`}>
                      {industry.icon}
                    </span>
                  </div>
